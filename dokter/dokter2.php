...
<body>
    ...
    <section class="profile-section">
        <img src="../src/dokterchae.jpg" alt=" Dr Chae Song Hwa">
        <div class="profile-info">
            <h2>Dr. Chae Song Hwa Sp.KJ</h2>
            <p><strong>Spesialis:</strong> Psikiater</p>
            <p><strong>Pendidikan:</strong></p>
            <ul>
                <li>Seoul National University - S1 Psychiatry</li>
                <li>Sungkyunkwan University - S2 Psychiatry</li>
            </ul>
